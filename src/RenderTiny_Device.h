...
public:
    ...
    Model(PrimitiveType t = Prim_Triangles) : Type(t), Fill(NULL), Visible(true), VertexBuffer(NULL), IndexBuffer(NULL) { }
    ~Model() { }
...
protected:
    ...
    Buffer*     pFullScreenVertexBuffer;
...
public:
	...
	virtual void Render(const Matrix4f& matrix, Mesh* mesh) = 0;
